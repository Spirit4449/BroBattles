...
We do not ask for or store a birthdate in this version. Please do not send passwords, card details, or unnecessary sensitive information in messages.
...
Session cookies keep you signed in. Other cookies and local storage support display names, preferences, and gameplay interface state. Blocking or clearing them may prevent sign-in or remove access to a temporary guest account.

This feature release does not add advertising or analytics trackers. Any optional analytics or nonessential tracking must be documented and configured with required choices before it is enabled.
...
Guest accounts are scheduled to expire after approximately two hours; cleanup runs periodically. Expiry does not necessarily remove related security, purchase, chat, or historical gameplay records at the same time.
...
Bro Battles is intended for ages 13 and older, and is not offered to children under 13. A parent or guardian should contact us if they believe a younger child has supplied personal information. We will investigate and take appropriate steps, including deletion where required.

Players under the age of majority must have a parent or guardian's permission. Additional protections or consent requirements may apply by region; the stated minimum age does not replace them.
