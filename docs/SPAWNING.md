...
The parachutes use the single-frame `parachutes/parachute-blue.webp` (you/allies) and `parachutes/parachute-red.webp` (opponents), drawn at 89 pixels high with their original proportions. Descent is capped at 88 px/s. Tuning constants live at the top of `src/gameScene/spawnIntro.js`.
