...
const POWERUP_RAGE_DAMAGE_MULT = POWERUP_CATALOG.rage.modifiers.damageMult;
const POWERUP_SHIELD_DAMAGE_MULT = POWERUP_CATALOG.shield.modifiers.damageTakenMult;
...
const NINJA_SWARM_HIT_DAMAGE = require("../../shared/characters").characterDefinitions.ninja.stats.tuning.special.swarm.damage;
